...
return [
    ...
    'connections' => [
        ...
        'local' => [
            ...
            'host'             => env('MQTT_CONNECTIONS_LOCAL_HOST', 'broker.hivemq.com'),
            'port'             => env('MQTT_CONNECTIONS_LOCAL_PORT', 1883),
            'protocol'         => MqttClient::MQTT_3_1,
            'client_id'        => env('MQTT_CONNECTIONS_LOCAL_CLIENT_ID', 'voltcore-backend-01'),
            ...
            'connection_settings' => [
                ...
                'auth' => [
                    'username' => env('MQTT_CONNECTIONS_LOCAL_USERNAME') ?: null,
                    'password' => env('MQTT_CONNECTIONS_LOCAL_PASSWORD') ?: null,
                ],
                'last_will' => [
